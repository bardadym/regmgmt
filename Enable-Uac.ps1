# Enable UAC in registry and restart servers
# 
# 2017 Viktor Bardadym

# Output program information
Write-Host -foregroundcolor White ""
Write-Host -foregroundcolor White "Enable UAC"
...
SetRegistryKey $farm 'LocalMachine' "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\policies\\system" "EnableLUA" 1 "DWord" $true 10
